...
def lambda_handler(event, context):
    ...
    query = """
    SELECT GAME_IS_PLAYED.PERIOD_ID, TOPIC, GAME_IS_PLAYED.SCORE, GAME_PERIOD.DAYS_REMAINING, TO_CHAR(GAME_PERIOD.CREATION_TIMESTAMP, 'YYYY/MM/DD') AS START_DATE, TO_CHAR(GAME_PERIOD.CREATION_TIMESTAMP+15, 'YYYY/MM/DD') AS END_DATE 
